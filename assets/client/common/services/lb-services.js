  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use BaseUser.accessTokens.findById() instead.
        "::findById::BaseUser::accessTokens": {
          url: urlBase + "/BaseUsers/:id/accessTokens/:fk",
          method: "GET"
        },

        // INTERNAL. Use BaseUser.accessTokens.destroyById() instead.
        "::destroyById::BaseUser::accessTokens": {
          url: urlBase + "/BaseUsers/:id/accessTokens/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use BaseUser.accessTokens.updateById() instead.
        "::updateById::BaseUser::accessTokens": {
          url: urlBase + "/BaseUsers/:id/accessTokens/:fk",
          method: "PUT"
        },

        // INTERNAL. Use BaseUser.accessTokens() instead.
        "::get::BaseUser::accessTokens": {
          isArray: true,
          url: urlBase + "/BaseUsers/:id/accessTokens",
          method: "GET"
        },

        // INTERNAL. Use BaseUser.accessTokens.create() instead.
        "::create::BaseUser::accessTokens": {
          url: urlBase + "/BaseUsers/:id/accessTokens",
          method: "POST"
        },

        // INTERNAL. Use BaseUser.accessTokens.destroyAll() instead.
        "::delete::BaseUser::accessTokens": {
          url: urlBase + "/BaseUsers/:id/accessTokens",
          method: "DELETE"
        },

        // INTERNAL. Use BaseUser.accessTokens.count() instead.
        "::count::BaseUser::accessTokens": {
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.BaseUser#getMyRoles
         * @methodOf lbServices.BaseUser
         *
         * @description
         *
        ...
        "getMyRoles": {
          isArray: true,
          url: urlBase + "/BaseUsers/getMyRoles",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.BaseUser#getMyResource
         * @methodOf lbServices.BaseUser
         *
         * @description
         *
        ...
        "getMyResource": {
          isArray: true,
          url: urlBase + "/BaseUsers/getMyResource",
          method: "GET"
        },
         ...
         * yet.
         *
         * @returns {Object} A BaseUser instance.
         */
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.BaseUser.accessTokens
     * @header lbServices.BaseUser.accessTokens
     * @object
     * @description
     *
     * The object `BaseUser.accessTokens` groups methods
     * manipulating `AccessToken` instances related to `BaseUser`.
     *
     * Call {@link lbServices.BaseUser#accessTokens BaseUser.accessTokens()}
     * to query all related instances.
     */
        ...
        R.accessTokens = function() {
          ...
          var action = TargetResource["::get::BaseUser::accessTokens"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.BaseUser.accessTokens#count
         * @methodOf lbServices.BaseUser.accessTokens
         *
         * @description
         *
        ...
        R.accessTokens.count = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::count::BaseUser::accessTokens"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.BaseUser.accessTokens#create
         * @methodOf lbServices.BaseUser.accessTokens
         *
         * @description
         *
        ...
        R.accessTokens.create = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::create::BaseUser::accessTokens"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.BaseUser.accessTokens#destroyAll
         * @methodOf lbServices.BaseUser.accessTokens
         *
         * @description
         *
        ...
        R.accessTokens.destroyAll = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::delete::BaseUser::accessTokens"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.BaseUser.accessTokens#destroyById
         * @methodOf lbServices.BaseUser.accessTokens
         *
         * @description
         *
        ...
        R.accessTokens.destroyById = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::destroyById::BaseUser::accessTokens"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.BaseUser.accessTokens#findById
         * @methodOf lbServices.BaseUser.accessTokens
         *
         * @description
         *
        ...
        R.accessTokens.findById = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::findById::BaseUser::accessTokens"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.BaseUser.accessTokens#updateById
         * @methodOf lbServices.BaseUser.accessTokens
         *
         * @description
         *
        ...
        R.accessTokens.updateById = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::updateById::BaseUser::accessTokens"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Resource#prototype$updateAttributes
         * @methodOf lbServices.Resource
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Resource#getAnonymous
         * @methodOf lbServices.Resource
         *
         * @description
         *
         ...
         */
        "getAnonymous": {
          url: urlBase + "/Resources/getAnonymous",
          method: "GET"
        },
      }
    );
...
/**
 * @ngdoc object
 * @name lbServices.RoleResourceMapping
 * @header lbServices.RoleResourceMapping
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `RoleResourceMapping` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/RoleResourceMappings/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#create
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `RoleResourceMapping` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/RoleResourceMappings",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#upsert
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#exists
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/RoleResourceMappings/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#findById
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/RoleResourceMappings/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#find
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#findOne
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/RoleResourceMappings/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#updateAll
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/RoleResourceMappings/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#deleteById
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#count
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/RoleResourceMappings/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#prototype$updateAttributes
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#updateOrCreate
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#update
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#destroyById
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.RoleResourceMapping#removeById
         * @methodOf lbServices.RoleResourceMapping
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.RoleResourceMapping#modelName
    * @propertyOf lbServices.RoleResourceMapping
    * @description
    * The name of the model represented by this $resource,
    * i.e. `RoleResourceMapping`.
    */
    R.modelName = "RoleResourceMapping";
