...
var paths = {
  ...
  styles: [
    ...
    'assets/client/common/directives/**/*.sass',
    'assets/client/common/directives/**/*.scss',
    'assets/client/common/directives/**/*.css'
  ],
...
gulp.task('combine', ['clean'], function () {
  var js = gulp.src(
    ['release/public/tmp/bower.js', 'release/public/tmp/vendor.js',
      'release/public/tmp/layout.js', 'release/public/tmp/view.js', 'release/public/tmp/directiveView.js',
...
gulp.task('views', function () {
  var assetsTemplate = gulp.src('assets/client/app/**/*.html')
    .pipe(htmlmin())
    .pipe(ngHtml2Js({
  ...
  var directiveTemplate = gulp.src('assets/client/common/directives/**/*.html')
    .pipe(htmlmin())
    .pipe(ngHtml2Js({
      moduleName: 'ui.partials',
      prefix: '../assets/client/common/directives/'
    }))
    .pipe(concat('directiveView.js'))
    .pipe(gulp.dest('release/public/tmp'));

  return merge(assetsTemplate, directiveTemplate);
});
...
gulp.task('inject_partials', function () {
  ...
  return gulp.src('assets/client/app/app.js')
    .pipe(injectString.after('angular.module(\'web starter kit\', [', '\'ui.partials\','))
    .pipe(gulp.dest('release/public/tmp'));
});
